...
#### How-to
- save the keys `TELEGRAM_BOT_TOKEN` and `TELEGRAM_CHAT_ID` in the secrets of your Repo's *GitHub Actions* environment
...
- use the *Action* in your Repo's workflow
...
5. enter this value in the secret `TELEGRAM_BOT_TOKEN` you have to create in your Repo's *GitHub Actions* environment :
    - in *Settings > Secrets and variables > Actions >* select the *Secrets* tab
...
- enter this value in the secret `TELEGRAM_CHAT_ID` you have to create in your Repo's *GitHub Actions* environment :
    - in *Settings > Secrets and variables > Actions >* select the *Secrets* tab
...
### Marche à suivre
- enregistrer les clefs `TELEGRAM_BOT_TOKEN` et `TELEGRAM_CHAT_ID` dans les secrets de l'environnement *GitHub Actions* sur votre Repo qui va utiliser l'*Action*
...
- appeler l'*Action* dans le workflow de votre Repo
...
6. donner cette valeur au secret `TELEGRAM_BOT_TOKEN` qu'il faut créer dans l'environnement *GitHub Actions* du Repo qui va utiliser l'*Action* :
...
- donner cette valeur au secret `TELEGRAM_CHAT_ID` qu'il faut créer dans l'environnement *GitHub Actions* du Repo qui va utiliser l'*Action* :
    - dans *Settings > Secrets and variables > Actions >* onglet *Secrets*
